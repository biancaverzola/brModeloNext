...
public class AboutWindow extends JDialog {
	...
	public AboutWindow(Frame owner) {
		...
		JLabel subtitleLabel = new JLabel("Para maiores informa��es visite https://code.google.com/p/brmodelonext/");
		...
		content.add(new JLabel("brModelo2All - Modelagem L�gica/Conceitual descomplicada para todos"));
		content.add(new JLabel(" "));

		content.add(new JLabel("Vers�o brModeloNext " + mxGraph.VERSION));
		content.add(new JLabel(" "));
		content.add(new JLabel(" "));
		content.add(new JLabel(" "));
		...
		try {
			...
			content.add(new JLabel("Vers�o do Sistema Operacional: " + System.getProperty("os.version")));
			content.add(new JLabel(" "));
			...
			content.add(new JLabel("Mem�ria Total: " + Runtime.getRuntime().totalMemory()));
			content.add(new JLabel("Mem�ria Livre: " + Runtime.getRuntime().freeMemory()));
			this.pack();
		} catch (Exception e) {
			// ignore
		}
